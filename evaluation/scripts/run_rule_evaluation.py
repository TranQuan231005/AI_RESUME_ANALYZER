...
Usage:
    python evaluation/scripts/run_rule_evaluation.py --output-report /tmp/rule-report.md
"""
...
def main():
    ...
    gt_path = ROOT_DIR / "evaluation" / "datasets" / "legacy" / "matching-ground-truth.json"
    jobs_path = ROOT_DIR / "evaluation" / "datasets" / "legacy" / "job-descriptions.json"
